...
class ComposerAutoloaderInita730267ebf2dbfb3c9833cbe46fe81d4
{
    ...
    public static function getLoader()
    {
        ...
        $includeFiles = \Composer\Autoload\ComposerStaticInita730267ebf2dbfb3c9833cbe46fe81d4::$files;
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequirea730267ebf2dbfb3c9833cbe46fe81d4($fileIdentifier, $file);
        }
 ...
 * @return void
 */
function composerRequirea730267ebf2dbfb3c9833cbe46fe81d4($fileIdentifier, $file)
{
